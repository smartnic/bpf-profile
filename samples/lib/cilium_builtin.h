...
__bpf_no_builtin_memset(void *d __maybe_unused, __u8 c __maybe_unused, __u64 len __maybe_unused) {
    __throw_build_bug();
}
...
static __always_inline __nobuiltin("memset") void memset_cilium(void *d, int c, __u64 len) {
...
static __always_inline __maybe_unused void __bpf_no_builtin_memcpy(void *d __maybe_unused,
...
static __always_inline __nobuiltin("memcpy") void memcpy_cilium(void *d, const void *s, __u64 len) {
    return __bpf_memcpy(d, s, len);
}

static __always_inline __maybe_unused __u64 __bpf_memcmp_builtin(const void *x, const void *y,
                                                                 __u64 len) {
...
static __always_inline __maybe_unused __u64 __bpf_no_builtin_memcmp(const void *x __maybe_unused,
 ...
 */
static __always_inline __nobuiltin("memcmp") __u64 memcmp_cilium(const void *x, const void *y, __u64 len) {
    return __bpf_memcmp(x, y, len);
}

static __always_inline __maybe_unused void __bpf_memmove_builtin(void *d, const void *s,
                                                                 __u64 len) {
...
static __always_inline __maybe_unused void __bpf_no_builtin_memmove(void *d __maybe_unused,
                                                                    const void *s __maybe_unused,
                                                                    __u64 len __maybe_unused) {
    __throw_build_bug();
}
...
static __always_inline __nobuiltin("memmove") void memmove_cilium(void *d, const void *s, __u64 len) {
