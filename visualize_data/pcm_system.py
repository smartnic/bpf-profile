...
PCM_OUTPUT = "avg_pcm_system_read.csv"
PCM_OUTPUT_STDEV = "avg_system_read_stdev.csv"
PCM_OUTPUT_EACH_RUN = "pcm_system_read.csv"
PCM_OUTPUT_FIG = "pcm_system_read.pdf"
    ...
    for line in f:
        ...
        if line_count == 0:
            ...
            if id_metric is None:
                ...
                return 0
            metric = float(line[i]) * 1000 / DURATION
            break
        line_count += 1
    f.close()
    return metric
