...
def gen_pcap_with_md_ddos_mitigator(num_cores, dst_mac, output_path, input_file):
...
if __name__ == '__main__':
    ...
    gen_pcap_with_md_ddos_mitigator(args.num_cores, dst_mac, args.output_path, args.input_file)
