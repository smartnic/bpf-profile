...
def gen_pcap_with_md_hhd(num_cores, dst_mac, output_path, input_file, tcp_only):
    global TCP_ONLY
    TCP_ONLY = tcp_only
...
if __name__ == '__main__':
    ...
    gen_pcap_with_md_hhd(args.num_cores, dst_mac, args.output_path, args.input_file, args.tcp_only)
